...
<style scoped>
.extract-page{max-width:1200px;margin:0 auto;padding:32px 24px}.page-header{margin-bottom:24px}.page-header h1{font-size:24px;font-weight:700;display:flex;align-items:center;gap:10px;color:#1e293b}.page-header p{font-size:14px;color:#64748b;margin-top:4px}.title-icon{color:var(--primary)}.extract-layout{display:grid;grid-template-columns:1fr 380px;gap:24px;align-items:stretch}.card{background:#fff;border-radius:16px;padding:24px;box-shadow:0 2px 12px rgba(0,0,0,.04);border:1px solid #e2e8f0}.card h3{font-size:16px;font-weight:600;display:flex;align-items:center;gap:8px;color:#1e293b;margin-bottom:20px}.result-count{font-size:13px;font-weight:400;color:#94a3b8;margin-left:auto}.result-list{display:flex;flex-direction:column;gap:10px}.result-card{display:flex;align-items:center;gap:14px;padding:14px 16px;background:#f8fafc;border-radius:12px;border:1px solid #e2e8f0;transition:all .2s}.result-card:hover,.result-card.playing{border-color:var(--primary);background:var(--primary-light)}.voice-icon{width:48px;height:48px;background:var(--primary-light);border-radius:12px;display:flex;align-items:center;justify-content:center;color:var(--primary);flex-shrink:0}.voice-info{flex:1;min-width:0}.voice-name{font-size:14px;font-weight:600;color:#1e293b;margin-bottom:4px}.voice-meta{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.tag{font-size:11px;padding:2px 8px;background:var(--primary-light);color:var(--primary);border-radius:4px;font-weight:500}.meta-item{display:flex;align-items:center;gap:3px;font-size:11px;color:#94a3b8}.voice-actions{display:flex;gap:4px;flex-shrink:0}.act-btn{width:32px;height:32px;border:1px solid #e2e8f0;border-radius:8px;background:#fff;color:#64748b;display:flex;align-items:center;justify-content:center;cursor:pointer;transition:all .15s}.act-btn:hover{border-color:var(--primary);color:var(--primary);background:var(--primary-light)}.play-btn{width:36px;height:36px;border-radius:50%;background:var(--primary);border:none;color:#fff}.play-btn:hover{background:var(--primary-hover);color:#fff}.empty-extract{display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;text-align:center;color:#94a3b8}.empty-icon{margin-bottom:12px;opacity:.4}.upload-zone{border:2px dashed #d1d5db;border-radius:12px;padding:40px 20px;text-align:center;cursor:pointer;transition:all .2s;margin-bottom:16px}.upload-zone:hover,.upload-zone.dragover,.upload-zone.has-file{border-color:var(--primary);background:#f8faff}.upload-icon{color:#94a3b8;margin-bottom:12px}.upload-text{font-size:14px;color:#475569;font-weight:500}.upload-hint{font-size:12px;color:#94a3b8;margin-top:4px}.file-preview{display:flex;align-items:center;gap:12px;color:#475569}.file-info{min-width:0;text-align:left}.file-name{display:block;font-weight:500;font-size:14px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.file-meta{font-size:12px;color:#94a3b8}.remove-file{width:24px;height:24px;border-radius:50%;border:1px solid #e2e8f0;background:#fff;color:#94a3b8;cursor:pointer;margin-left:auto}.remove-file:hover{background:#fef2f2;border-color:#fecaca;color:#ef4444}.clone-form{display:grid;gap:8px;margin-bottom:16px}.field-label{font-size:12px;font-weight:600;color:#64748b}.form-input{height:38px;border:1px solid #d1d5db;border-radius:8px;padding:0 10px;color:#1e293b;background:#fff}.form-input:focus{outline:none;border-color:var(--primary);box-shadow:0 0 0 3px rgba(99,102,241,.12)}.extract-btn{width:100%;padding:14px;background:linear-gradient(135deg,var(--primary),#7c3aed);color:#fff;border:none;border-radius:10px;font-size:15px;font-weight:600;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;transition:all .15s}.extract-btn:hover:not(:disabled){transform:translateY(-1px);box-shadow:0 4px 14px rgba(99,102,241,.4)}.extract-btn:disabled{opacity:.5;cursor:not-allowed}.clone-progress-card{margin:12px 0 0;padding:12px;border:1px solid #e2e8f0;border-radius:10px;background:#fff}.clone-progress-header{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:8px;font-size:13px;color:#64748b}.clone-progress-header strong{color:var(--primary)}.clone-progress-track{height:8px;overflow:hidden;border-radius:999px;background:#eef2f7}.clone-progress-fill{height:100%;border-radius:inherit;background:var(--primary);transition:width .25s ease}.spin{animation:spin 1s linear infinite}@keyframes spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}.extract-status{margin-top:12px;padding:10px 14px;border-radius:8px;font-size:13px;text-align:center}.extract-status.success{background:#f0fdf4;color:#16a34a;border:1px solid #bbf7d0}.extract-status.error{background:#fef2f2;color:#dc2626;border:1px solid #fecaca}@media(max-width:768px){.extract-layout{grid-template-columns:1fr}.extract-right{order:-1}}
</style>